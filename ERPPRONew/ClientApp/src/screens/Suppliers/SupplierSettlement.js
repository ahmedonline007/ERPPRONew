...
class SupplierSettlement extends Component {
    ...
    componentDidMount() {
        ...
        this.props.actions.getAllSettlement(true);
    }
            ...
            <Fragment>
                <div className="main_content_container">
                    <div className="page_content">
                        <br />
                        <br />
                        <h1 className="heading_title"> تسوية  الموردين بالنقصان</h1>
...
export default connect(mapStateToProps, mapDispatchToProps)(SupplierSettlement);