...
class PaymentSupplier extends Component {
    ...
    componentDidMount() {
        ...
        this.props.actions.getPayedDebt(true);
    }
    ...
    EditCreditDepit(value) {
        ...
        if (value.credit <= 0) {
            ...
            // this.props.actions.getCreditDepit(value.customerId);
            ...
            <Fragment>
                <div className="main_content_container">
                    <div className="page_content">
                        <br />
                        <br />
                        <h1 className="heading_title">سداد مديونية الموردين</h1>
                ...
                <div className="row" id="DivPrint1" style={{ display: "none" }}>
                    ...
                    <div> المورد :  {this.state.customerId.label}</div>
                    <div>
                        <Form.Group controlId="credit">
                            <Form.Label>دائن : </Form.Label>
                            <Form.Label>{this.props.objCreditDebit.credit}</Form.Label>
