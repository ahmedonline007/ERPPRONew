...
class TransactionSuppliersStore extends Component {
    ...
    componentDidMount() {
        ...
        this.props.actions.getTransactionSupplierCustomerStore(true);
    }
    ...
    viewDetails = (state, rowInfo, column, instance) => {
        ...
        return {
            onClick: (e, handleOriginal) => {
                ...
                if (rowInfo.original.type === "تسجيل فاتورة مشتريات") {
                    ...
                    let items = this.state.listTransaction.find(x => x.id === rowInfo.original.id).listPurchaseOrderDetails;
                        ...
                        items.forEach(i => {
                            ...
                            i.totalPrice = i.type === true ? (i.priceSupplier * (i.meter + "." + parseFloat(i.centi))).toFixed(0) : (i.priceSelling * i.quantity).toFixed(0)
                        });
            ...
            <Fragment>
                <div className="main_content_container">
                    <div className="page_content">
                        <br />
                        <br />
                        <h1 className="heading_title">عرض حركة رصيد الموردين</h1>
                ...
                <div id="DivPrint" style={{ display: "none" }}>
                    <h1 className="heading_title">عرض حركة ترصيد الموردين</h1>
                    <br />
                    <br />
...
export default connect(mapStateToProps, mapDispatchToProps)(TransactionSuppliersStore);
