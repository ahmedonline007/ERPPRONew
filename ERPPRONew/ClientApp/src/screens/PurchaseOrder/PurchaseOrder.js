...
import { Form, Modal, Table, OverlayTrigger, Tooltip } from 'react-bootstrap';
...
class PurchaseOrder extends Component {
    ...
    showModal() {
        this.props.history.push("/PurchaseOrderAddEdit/0/false");
    }
                ...
                if (e.target.className === "Edit") {
                    ...
                    if (items.isPrice === "لم تسعر") {
                        ...
                        items.forEach(i => {
                            ...
                            let xx = (i.meter + "." + i.centi);
                            i.totalPrice = i.type === true ? (i.priceSupplier * xx).toFixed(0) : (i.priceSupplier * i.quantity).toFixed(0);
                        });
    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <Modal show={this.state.show} onHide={this.handleClose.bind(this)} style={{ opacity: 1, marginTop: '10%', fontWeight: "bold", fontSize: "25px", width: "100%" }}>
