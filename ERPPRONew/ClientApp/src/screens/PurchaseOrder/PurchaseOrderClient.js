...
class PurchaseOrderClient extends Component {

    constructor(props) {

        super(props);
        if (!Config.IsAllow(65)) {
        ...
        this.cells = [
            //{
            //    Header: <strong> رقم فاتورة من السيستم </strong>,
            //    accessor: 'numberOfInvoiceBySystem',
            //    width: 100,
            //    filterable: true,
            //},
            {
                Header: <strong> رقم القسيمة </strong>,
    ...
    showModal() {
        this.props.history.push("/PurchaseOrderAddEditClient/0");
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(PurchaseOrderClient);
