...
class InvoicesByCustomer extends Component {
    ...
    handleDropDownChange(value) {
        let listInvoices = this.props.listInvoices.filter(x => x.customerId === value);
    ...
    printcontent(el) {
        ...
        this.props.history.push("/InvoicesByCustomer");
            ...
            <Fragment>
                <div className="main_content_container">
                    <div className="page_content">
                        <br />
                        <br />
                        <h1 className="heading_title">فواتير بيع للعملاء</h1>
                        ...
                        <div className="page-title-actions">
                            <Form.Group controlId="customerId">
                                ...
                                <Select
                                    ...
                                    id="customerId" 
                                    onChange={(opt) => {
                                        this.handleDropDownChange(opt.value)
                                    }}
...
export default connect(mapStateToProps, mapDispatchToProps)(InvoicesByCustomer);
