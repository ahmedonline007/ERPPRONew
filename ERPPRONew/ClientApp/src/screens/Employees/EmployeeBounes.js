...
class EmployeeBounes extends Component {
    ...
    componentWillReceiveProps(nextState, prevState) {
        if (nextState.listEmployeeBounes && nextState.listEmployeeBounes.length > 0) {
    ...
    componentDidMount() {
        this.props.actions.getAllEmployeesBounes();
    ...
    addEditEmployee = (values) => {
        if (this.state.employeeName.value > 0) {
            ...
            this.props.actions.addEditEmployeeBounes(values);
        } else {
    ...
    handleDelete = () => {
        ...
        this.props.actions.deleteEmployeesBounes(this.state.selected[0]);
            ...
            <Fragment>
                <div className="main_content_container">
                    <div className="page_content">
                        <br />
                        <br />
                        <h1 className="heading_title">عرض كل سلف الموظفين</h1>
                        ...
                        {/* List Of Data */}
                        <ReactTable
                            data={this.props.listEmployeeBounes}
                            columns={this.cells}
                            ...
                            {({ handleSubmit, handleChange, handleBlur, values, touched, isValid, errors, }) => (
                                <Form noValidate onSubmit={handleSubmit} style={{ fontWeight: 'bold', fontSize: '25px' }}>
                                    ...
                                    <Form.Group controlId="salary">
                                        <Form.Label>قيمة السلف</Form.Label>
                                        <Form.Control
                                            style={{ height: "50px" }}
                                            type="text"
                                            placeholder="قيمة السلف"
                                            onChange={handleChange}
                                            aria-describedby="inputGroupPrepend"
                                            name="salary"
                                            value={values.salary}
                ...
                <div id="DivPrint" style={{ display: "none" }}>
                    ...
                    <Table striped bordered hover>
                        ...
                        <tbody>
                            {
                                this.props.listEmployeeBounes.length > 0 ?
                                    this.props.listEmployeeBounes.map((item, i) => {
                                        return (<tr key={i}>
...
const mapStateToProps = (state, ownProps) => ({
    listEmployeeBounes: state.reduces.listEmployeeBounes,
...
export default connect(mapStateToProps, mapDispatchToProps)(EmployeeBounes);