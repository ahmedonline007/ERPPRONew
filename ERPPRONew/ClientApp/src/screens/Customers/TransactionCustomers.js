...
class TransactionCustomers extends Component {

    constructor(props) {

        super(props);
        if (!Config.IsAllow(57)) {
    ...
    componentDidMount() {
        ...
        this.props.actions.getTransactionSupplierCustomer(false);
    }
            ...
            <Fragment>
                <div className="main_content_container">
                    <div className="page_content">
                        <br />
                        <br />
                        <h1 className="heading_title">عرض حركة العملاء</h1>
...
export default connect(mapStateToProps, mapDispatchToProps)(TransactionCustomers);
