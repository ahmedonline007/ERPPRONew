...
class CustomerIndebtednesses extends Component {
    ...
    componentDidMount() {
        ...
        this.props.actions.getAllIndebtedness(false);
    }
            ...
            <Fragment>
                <div className="main_content_container">
                    <div className="page_content">
                        <br />
                        <br />
                        <h1 className="heading_title"> تسوية مديونية العملاء بالزيادة</h1>
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerIndebtednesses);